...
export USER=vivit_felipe_90_10 # Will create an audiocraft_vivit_felipe folder inside checkpoints
...
dora -P audiocraft run -d \
    ...
    conditioners.video.vivit.finetune=false \
    conditioner=vivit2music \
    dset=snes_mvdb_90_10 \
