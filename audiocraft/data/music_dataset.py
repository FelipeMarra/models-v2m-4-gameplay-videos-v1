...
class Paraphraser:
    ...
    def sample_paraphrase(self, audio_path: str, description: tp.Union[str, None]):
...
class MusicDataset(InfoAudioDataset):
    ...
    """
    def __init__(
            self, *args, info_fields_required: bool = True,
        ...
        #print("@@@@@ data.music_dataset.MusicDataset.__init__")
        kwargs['return_info'] = True  # We require the info for each song of the dataset.
        super().__init__(*args, **kwargs)
        #print("@@@@@ data.music_dataset.MusicDataset.__init__ after super __init__")
    ...
    def __getitem__(self, index):
        #print(f"\n##### MusicDataset __getitem__")
        wav, info = super().__getitem__(index) # We still have no descriptions but the path to the meta file is there
        #print(f"##### MusicDataset __getitem__ after super()")
        ...
        if Path(music_info_path).exists():
            ...
            if self.paraphraser is not None:
                music_info.description = self.paraphraser.sample_paraphrase(music_info.meta.path, music_info.description)
